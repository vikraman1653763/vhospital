    ...
    <section className="service-sec-8">
      <div className="service-sec-8-content">
        ...
        <div className="service-sec-8-points">
          <ul>
            <li className='service-sec-8-point'><MdMedicalServices /> Full range of routine testing for hospitals</li>
            <li className='service-sec-8-point'><FaTruck /> Collection & transportation support</li>
            <li className='service-sec-8-point'><FaTasks/> Day-to-day operations management</li>
            <li className='service-sec-8-point'><MdScience /> Clinical, Biochemistry, Pathology, and Microbiology services</li>
            <li className='service-sec-8-point'><FaStethoscope /> Point of Care Testing (POCT)</li>
            <li className='service-sec-8-point'><FaCheckCircle /> Quality Assurance Programme</li>
          </ul>
        </div>
        <p className="service-sec-8-description">
